const script = () => {
    ...
    const HEADER = {
        ...
        search: () => {
            ...
            searchTarget.on('submit', function(e) {
                ...
                window.location.href = window.location.origin + '/books?name=' + encodeURI(searchParam)
            })
    ...
    SCRIPT.bookDetailScript = () => {
        ...
        BLOG_DETAIL.Thumb = () => {
            ...
            $('.book__showcase-cms-list:not(".mod-lg") .book__showcase-cms-item:last-child').remove();
            $('.book__showcase-cms-list.mod-lg .book__showcase-cms-item:first-child').remove();
